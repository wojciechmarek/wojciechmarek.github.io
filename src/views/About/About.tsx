  ...
  return (
    <AboutContainer id="about">
      <AboutContent>
        ...
        <AboutTextParagraph>
          Because you are here, let me tell you something more about me... To
          make a long story short, create web applications using Angular, React,
          and Nest.js. Previously I have worked with C# language and .NET
          framework, but JavaScript (or, to be more precise - Typescript) took
          my heart.
        </AboutTextParagraph>
        <AboutTextParagraph>
          I started my journey with programming at the end of 2012, playing with
          C programming language to create simple batch programs that run the
        ...
        <AboutTextParagraph>
          ...
          operating systems, computer networks, etc. I have also learned about
          C# programming language and the .NET framework. Having better
        ...
        <AboutTextParagraph>
          ...
          working on a J1 visa. After returning to Poland, I started my first
          real job as a Junior Software Engineer. Until now, I have kept
